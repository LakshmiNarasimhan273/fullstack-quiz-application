...
const Result = ({ username }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4">
      ...
      <div className="bg-gray-200 text-white p-6 flex justify-between text-center rounded-lg mb-6 w-full">
        <div>
          <p className="text-lg text-black">Total</p>
          <p className="text-4xl text-black">{API.length}</p>
        </div>
        <div>
          <p className="text-lg text-black ">Correct</p>
          <p className="text-4xl text-green-600">{result}</p>
        </div>
        <div>
          <p className="text-lg text-black">Wrong</p>
